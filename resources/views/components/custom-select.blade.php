...
<div class="relative custom-select-container inline-block w-full sm:w-auto" id="{{ $id }}-container" data-multiple="{{ $multiple ? 'true' : 'false' }}">
    ...
    {{-- Dropdown Menu --}}
    <div class="custom-select-dropdown hidden absolute left-0 sm:right-auto right-0 sm:left-0 mt-2 w-56 max-h-80 overflow-y-auto bg-white border-[1.5px] border-[#444] rounded-xl shadow-lg z-[100]">
        @if($title)
        ...
        <div class="flex flex-col py-1 custom-select-options">
