...
<div class="h-[64px] flex items-center justify-between px-4 border-b">
    <div class="flex items-center gap-2">
        ...
        <button class="w-9 h-9 bg-[#FFDDAF] border border-[#444] rounded-full">+</button>
    </div>
...
<div class="h-[64px] flex items-center gap-3 px-4 border-b bg-white">
    ...
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button onclick="sendMessage()" class="w-9 h-9 bg-[#FFDDAF] border border-[#444] rounded-full">➤</button>
    </div>
